...
<div>
    ...
    <div className="col-lg-3 col-md-6 mb-3">
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg service-card-bg1" onclick="window.location='#'">
            ...
            <h5 className="card-title fw-bold mb-md-5 text-white ">Interior Painting</h5>
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg  service-card-bg2" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 text-white">Exterior Painting</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 ">Power Washing</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 ">Sanding and Priming</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
...
<div className="row">
    <div className="col-lg-3 col-md-6 mb-3">
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg service-card-bg1" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 text-white ">Drywall Repair and Patching</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg  service-card-bg2" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 text-white">Restoration and Historical Painting</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
        ...
        <div className="s-card card text-center h-100 pt-5 pb-2 shadow-lg" onclick="window.location='#'">
            <div className="card-body">
            <i class="fa-solid fa-house-laptop mb-3"></i> 
            <h5 className="card-title fw-bold mb-md-5 ">Textures and Patterns</h5>
            <button className="btn card-btn w-100">BOOK NOW</button>
            </div>
        </div>
        </Link>
